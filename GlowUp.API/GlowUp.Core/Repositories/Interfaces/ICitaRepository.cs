...
public interface ICitaRepository
{
    ...
    Task<bool> EmpleadoPuedeOfrecerServiciosAsync(long empleadoId, IReadOnlyCollection<long> servicioIds, CancellationToken cancellationToken = default);
    Task<Empleado?> ObtenerEmpleadoAsync(long negocioId, long sucursalId, long empleadoId, CancellationToken cancellationToken = default);
    Task<List<AusenciasEmpleado>> ObtenerAusenciasActivasAsync(long empleadoId, DateTime iniciaEn, DateTime terminaEn, CancellationToken cancellationToken = default);
    Task<FeriadoNegocio?> ObtenerFeriadoAsync(long negocioId, long sucursalId, DateOnly fecha, CancellationToken cancellationToken = default);
    ...
    Task<List<Empleado>> ObtenerEmpleadosAsync(long negocioId, long? sucursalId, CancellationToken cancellationToken = default);
